...
|---------------------------|------------------|
| S3 Bucket with files       | ![](screenshots/https://github.com/RahulKagra/Automated-S3-Bucket-Cleanup-Using-AWS-Lambda-and-Boto3/blob/main/Test%20of%20Setup.png?raw=true|
re.png) |
